...
class QuickQuotePublicForm(forms.Form):
    ...
    agent_name = forms.CharField(required=False)
    agent_email = forms.EmailField(required=False)
    insured_name = forms.CharField(required=False)
    primary_practice_street = forms.CharField(required=False)
    primary_practice_building = forms.CharField(required=False)
    primary_practice_city = forms.CharField(required=False)
    primary_practice_zip_code = forms.CharField(required=False)
